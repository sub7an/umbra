  ...
  return (
    <group>
      ...
      <mesh ref={p1Ref}>
        ...
        <meshStandardMaterial color="#f59e0b" emissive="#f59e0b" emissiveIntensity={3.5} roughness={0} />
        <pointLight color="#f59e0b" intensity={2.0} distance={3.5} decay={2} />
      </mesh>
      ...
      <Html position={[4.2, 3.0, 0]} center style={{ pointerEvents: 'none' }}>
        <div style={{
          ...
          <div style={{ fontSize: 8, color: 'rgba(245,158,11,0.4)', marginBottom: 5 }}>F = q(E+v×B)</div>
          <div style={{ color: '#f59e0b', marginBottom: 2 }}>
            <span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%',
              background: '#f59e0b', marginRight: 4, verticalAlign: 'middle' }} />
            q = +1
          </div>
