  ...
  switch (view) {
    ...
    case 'rotationcurve':
      return {
        ...
        primaryEq: `\\textcolor{#f59e0b}{v_{\\mathrm{obs}}} \\gg \\textcolor{#f59e0b}{v_{\\mathrm{kep}}}`,
        derivedEqs: [
          {
          ...
          },
          {
            ...
            eq: `\\textcolor{#f59e0b}{v_{\\mathrm{obs}}} = ${vo.toFixed(3)},\\;\\textcolor{#f59e0b}{v_{\\mathrm{kep}}} = ${vk.toFixed(3)}`,
          },
        ],
      }
