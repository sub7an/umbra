  ...
  switch (view) {
        ...
        derivedEqs: [
          {
            ...
            eq: `\\textcolor{#b44dff}{\\gamma} = \\dfrac{1}{\\sqrt{1-\\textcolor{#f59e0b}{\\beta}^2}}`,
          },
          {
            label: 'Current',
            eq: `\\textcolor{#f59e0b}{\\beta} = ${b},\\;\\textcolor{#b44dff}{\\gamma} = ${g}`,
          },
        ],
      }
    ...
    case 'timedilation':
      return {
        ...
        primaryEq: `\\textcolor{#f59e0b}{t'} = \\textcolor{#b44dff}{\\gamma}\\,t_0`,
        derivedEqs: [
          {
            label: 'Lorentz factor',
            eq: `\\textcolor{#b44dff}{\\gamma} = \\dfrac{1}{\\sqrt{1-\\textcolor{#f59e0b}{\\beta}^2}}`,
    ...
    case 'lengthcontraction':
      return {
        ...
        primaryEq: `\\textcolor{#e040fb}{L'} = \\dfrac{L_0}{\\textcolor{#b44dff}{\\gamma}}`,
        derivedEqs: [
          {
            label: 'Proper length',
            eq: `L_0 = 3.000\\text{ u}`,
...
function drawDiagGraph(ctx, w, h, history) {
  ...
  trace('rgba(180,77,255,0.88)', 'E')           // cyan: energy E = γ
          ...
          <div className="px-3 pt-3 pb-2 border-b border-border-subtle">
            ...
            <div className="flex gap-4 mt-2">
              <span className="flex items-center gap-1.5 font-mono-data text-[9px] text-text-dim">
                <span className="inline-block w-3 rounded" style={{ height: 1.5, background: 'rgba(180,77,255,0.88)' }} />
                E = γ
              </span>
              <span className="flex items-center gap-1.5 font-mono-data text-[9px] text-text-dim">
