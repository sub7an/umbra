...
function StateArrow({ vecPos }) {
  ...
  return (
    <group>
      <Line points={[[0, 0, 0], vecPos]} color="#f59e0b" lineWidth={3} />
...
export default function BlochSphere() {
  ...
  return (
    <group ref={groupRef}>
      ...
      {/* Axes */}
      <Line points={[[0, -1.45, 0], [0, 1.45, 0]]} color="#f59e0b" lineWidth={1} transparent opacity={0.45} />
      ...
      <Html position={[0, 1.55, 0]}    center style={{ pointerEvents: 'none' }}>
        <span style={{ ...LABEL_STYLE, color: '#f59e0b', textShadow: '0 0 8px rgba(245,158,11,0.7)' }}>|0⟩</span>
      </Html>
      <Html position={[0, -1.55, 0]}   center style={{ pointerEvents: 'none' }}>
        <span style={{ ...LABEL_STYLE, color: '#f59e0b', textShadow: '0 0 8px rgba(245,158,11,0.7)' }}>|1⟩</span>
      </Html>
      ...
      <pointLight position={vecPos} color="#f59e0b" intensity={0.4} distance={2} />
    </group>
  )
}
