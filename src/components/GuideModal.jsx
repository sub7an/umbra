      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 11 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            color: 'rgba(237,233,255,0.78)', lineHeight: 1.7, letterSpacing: '-0.01em',
          }}>{f.desc}</div>
          <div style={{
            marginTop: 7,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: 'rgba(237,233,255,0.70)', lineHeight: 1.5, letterSpacing: '-0.01em',
      }}>{desc}</div>
    </div>
  )
}
      ...
      {!activeModule && (
        <button
          ...
          style={{
            ...
            background: open ? 'rgba(255,255,255,0.08)' : 'rgba(7,4,26,0.72)',
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 12,
              boxShadow: '0 32px 100px rgba(0,0,0,0.9), 0 0 60px rgba(180,77,255,0.04)',
              overflow: 'hidden',
          ...
          >
            ...
            <div style={{
              ...
              background: 'linear-gradient(135deg, rgba(180,77,255,0.04) 0%, transparent 50%)',
              flexShrink: 0,
            }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                <div>
                  <div style={{
                    fontFamily: 'JetBrains Mono, monospace', fontSize: 10,
                    letterSpacing: '0.18em', color: 'rgba(180,77,255,0.65)', marginBottom: 6,
                  }}>
                  ...
                  {firstRun && (
                    <div style={{
                      fontFamily: "'Inter', system-ui, sans-serif", fontSize: 13,
                      color: 'rgba(237,233,255,0.65)', marginTop: 6, lineHeight: 1.6, letterSpacing: '-0.01em',
                    }}>
                ...
                {[['features', 'Features'], ['shortcuts', 'Shortcuts']].map(([id, label]) => (
                  <button
                    ...
                    style={{
                      ...
                      color: tab === id ? '#07041a' : 'rgba(237,233,255,0.55)',
                      background: tab === id ? '#b44dff' : 'transparent',
                      border: `1px solid ${tab === id ? '#b44dff' : 'rgba(255,255,255,0.08)'}`,
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px' }}>
              {tab === 'features' ? (
                ...
                <div style={{ paddingTop: 4 }}>
                  <div style={{
                    fontFamily: 'JetBrains Mono, monospace', fontSize: 10,
                    letterSpacing: '0.14em', color: 'rgba(180,77,255,0.60)',
                    marginBottom: 12,
                  ...
                  <div style={{ marginTop: 20 }}>
                    <div style={{
                      ...
                      letterSpacing: '0.16em', color: 'rgba(180,77,255,0.4)',
                      marginBottom: 12,
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 4px 16px rgba(180,77,255,0.25)',
