      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 11 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            color: 'rgba(247,248,248,0.78)', lineHeight: 1.7, letterSpacing: '-0.01em',
          }}>{f.desc}</div>
          <div style={{
            marginTop: 7,
      ...
      {!activeModule && (
        <button
          ...
          style={{
            ...
            background: open ? 'rgba(255,255,255,0.08)' : 'rgba(8,9,10,0.72)',
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 12,
              boxShadow: '0 32px 100px rgba(0,0,0,0.9), 0 0 60px rgba(94,106,210,0.04)',
              overflow: 'hidden',
          ...
          >
            ...
            <div style={{
              ...
              background: 'linear-gradient(135deg, rgba(94,106,210,0.04) 0%, transparent 50%)',
              flexShrink: 0,
            }}>
