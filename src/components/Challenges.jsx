...
function VerifyPanel({ challenge, onSuccess, onDismiss }) {
  ...
  return (
    <div style={{
      ...
      background: 'rgba(10,10,12,0.96)', border: '1px solid rgba(94,106,210,0.14)',
      ...
      <button
        ...
        onMouseEnter={e => { e.currentTarget.style.background = 'rgba(94,106,210,0.13)'; e.currentTarget.style.borderColor = 'rgba(94,106,210,0.5)' }}
        onMouseLeave={e => { e.currentTarget.style.background = 'rgba(94,106,210,0.07)'; e.currentTarget.style.borderColor = 'rgba(94,106,210,0.25)' }}
      >
        VERIFY →
      </button>
    </div>
    ...
    <>
      ...
      {!activeModule && (
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.color = allDone ? '#10b981' : 'rgba(94,106,210,0.9)'; e.currentTarget.style.borderColor = allDone ? 'rgba(16,185,129,0.5)' : 'rgba(94,106,210,0.35)' }}
          onMouseLeave={e => { e.currentTarget.style.color = allDone ? '#10b981' : 'rgba(94,106,210,0.55)'; e.currentTarget.style.borderColor = allDone ? 'rgba(16,185,129,0.3)' : 'rgba(94,106,210,0.14)' }}
        >
      ...
      {open && (
        <div
          style={{ position:'fixed',inset:0,zIndex:10200,background:'rgba(8,9,10,0.85)',backdropFilter:'blur(12px)',WebkitBackdropFilter:'blur(12px)',display:'flex',alignItems:'flex-start',justifyContent:'center',paddingTop:'8vh',overflowY:'auto' }}
          onClick={() => setOpen(false)}
        >
          <div
            style={{ width:'100%',maxWidth:640,margin:'0 16px 32px',background:'rgba(10,10,12,0.98)',border:'1px solid rgba(94,106,210,0.14)',borderRadius:6,overflow:'hidden',boxShadow:'0 32px 80px rgba(0,0,0,0.8)' }}
          ...
          >
            ...
            {/* Progress bar */}
            <div style={{ height:2,background:'rgba(94,106,210,0.06)' }}>
              <div style={{ height:'100%',background:'rgba(94,106,210,0.45)',width:`${(doneToday/CHALLENGES.length)*100}%`,transition:'width 0.4s' }} />
            </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom:'1px solid rgba(94,106,210,0.04)',
                      opacity: done ? 0.55 : 1,
                    }}
                  >
                    {/* Icon */}
