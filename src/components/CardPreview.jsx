  ...
  return (
    <group ref={groupRef}>
      ...
      {[...Array(9)].map((_, ri) => {
        ...
        return (
          <line key={`f${ri}`} geometry={geo}>
            <lineBasicMaterial color="#5e6ad2" transparent opacity={0.25 + ri * 0.05} />
          </line>
        )
      })}
      {/* Past cone (inverted) */}
      {[...Array(9)].map((_, ri) => {
        ...
        return (
          <line key={`p${ri}`} geometry={geo}>
            <lineBasicMaterial color="#5e6ad2" transparent opacity={0.12 + ri * 0.03} />
          </line>
        )
      })}
      {/* Time axis */}
      <line geometry={new THREE.BufferGeometry().setFromPoints([
        ...
        <lineBasicMaterial color="#5e6ad2" transparent opacity={0.6} />
      </line>
      <pointLight position={[0, 0, 0]} color="#5e6ad2" intensity={1} distance={3} />
    </group>
  )
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {visible && <ActiveScene moduleId={displayMod} />}
      </Canvas>
    </div>
  )
}
