...
const PALETTE_MODULES = [
  ...
  { id: 'special-relativity', name: 'Special Relativity', abbr: 'SR', color: '#b44dff', formula: 'γ = 1/√(1−β²)',          tags: ['relativity','lorentz','time dilation','length contraction','minkowski'] },
    ...
    >
      <div
        style={{
          ...
          boxShadow: '0 0 0 1px rgba(180,77,255,0.05), 0 32px 80px rgba(0,0,0,0.75)',
      ...
      >
        ...
        <div style={{
          ...
          padding: '13px 16px',
          borderBottom: '1px solid rgba(180,77,255,0.09)',
        }}>
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" style={{ flexShrink: 0, opacity: 0.38 }}>
            <circle cx="5.5" cy="5.5" r="4" stroke="#b44dff" strokeWidth="1.4"/>
            <path d="M9 9L11.5 11.5" stroke="#b44dff" strokeWidth="1.4" strokeLinecap="round"/>
          </svg>
          <input
            ref={inputRef}
            value={query}
            ...
            style={{
              ...
              fontSize: 13, color: '#ede9ff', letterSpacing: '0.02em',
            }}
          />
          <kbd style={{
            fontFamily: 'JetBrains Mono, monospace', fontSize: 9,
            color: 'rgba(180,77,255,0.32)',
            border: '1px solid rgba(180,77,255,0.13)',
        ...
        <div ref={listRef} style={{ overflowY: 'auto', flex: 1 }}>
          {results.length === 0 ? (
            <div style={{
              ...
              color: 'rgba(180,77,255,0.22)', letterSpacing: '0.12em',
            }}>
              NO MODULES MATCH
            </div>
          ) : results.map((mod, i) => (
            <div
              ...
              style={{
                ...
                background: i === sel ? 'rgba(180,77,255,0.045)' : 'transparent',
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{
                  ...
                  color: i === sel ? '#ede9ff' : 'rgba(223,242,237,0.6)',
        ...
        <div style={{
          ...
          {[['↑↓', 'navigate'], ['↵', 'open'], ['⌘K', 'close']].map(([key, lbl]) => (
            <div key={key} style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
              ...
              <span style={{
                fontFamily: 'JetBrains Mono, monospace', fontSize: 8,
                color: 'rgba(180,77,255,0.2)', letterSpacing: '0.09em',
              }}>{lbl}</span>
            </div>
          ))}
        </div>
