  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        padding: '8px 12px', borderBottom: '1px solid rgba(94,106,210,0.08)',
      ...
      <div style={{ padding: '12px' }}>
        {loading ? (
          <div style={{ display:'flex', gap:4 }}>
            {[0,1,2].map(i => (
              <span key={i} style={{ display:'inline-block', width:4, height:4, borderRadius:'50%', background:'rgba(94,106,210,0.4)', animation:`umbra-pulse 1s ease-in-out ${i*0.18}s infinite` }} />
            ))}
          </div>
        ) : (
  ...
  return (
    <div style={{
      ...
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <circle cx="14" cy="14" r="5" stroke="#5e6ad2" strokeWidth="1" opacity="0.7"/>
        <line x1="14" y1="0" x2="14" y2="8"  stroke="#5e6ad2" strokeWidth="1" opacity="0.7"/>
        <line x1="14" y1="20" x2="14" y2="28" stroke="#5e6ad2" strokeWidth="1" opacity="0.7"/>
        <line x1="0" y1="14" x2="8"  y2="14" stroke="#5e6ad2" strokeWidth="1" opacity="0.7"/>
        <line x1="20" y1="14" x2="28" y2="14" stroke="#5e6ad2" strokeWidth="1" opacity="0.7"/>
      </svg>
    </div>
  )
}
