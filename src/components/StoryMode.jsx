    ...
    <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
      {Array.from({ length: total }).map((_, i) => (
        <div key={i} style={{
          ...
          height: 6,
          borderRadius: 3,
          background: i < current ? 'rgba(245,158,11,0.5)' : i === current ? '#f59e0b' : 'rgba(255,255,255,0.12)',
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            color: 'rgba(254,249,236,0.62)', letterSpacing: 'normal', marginBottom: 8,
      ...
      {stepsDone >= 0 && (
        <div style={{ marginTop: 12, height: 2, background: 'rgba(255,255,255,0.06)', borderRadius: 1, overflow: 'hidden' }}>
          <div style={{
            ...
            background: done ? '#f59e0b' : journey.color,
            ...
            <div style={{ padding: '14px 16px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.12em',
                  color: '#060404', background: journey.color,
      ...
      {!activeModule && (
        <button
          ...
          style={{
            ...
            background: open ? 'rgba(245,158,11,0.08)' : 'rgba(8,6,4,0.72)',
            border: `1px solid ${open ? 'rgba(245,158,11,0.3)' : 'rgba(245,158,11,0.12)'}`,
            borderRadius: 5,
        ...
        >
          ...
          JOURNEYS
          {totalXP > 0 && (
            <span style={{ color: '#f59e0b', marginLeft: 2 }}>{totalXP} XP</span>
          )}
        </button>
      )}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.16em', color: 'rgba(245,158,11,0.65)', marginBottom: 4 }}>STORY MODE</div>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 14, fontWeight: 700, color: '#e8f4f0' }}>Guided Journeys</div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: 'rgba(245,158,11,0.60)', letterSpacing: '0.12em' }}>TOTAL XP</div>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 16, fontWeight: 700, color: '#f59e0b' }}>{totalXP}</div>
              </div>
            </div>
            <p style={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: 13, color: 'rgba(254,249,236,0.65)', lineHeight: 1.6, margin: '8px 0 0', letterSpacing: '-0.01em' }}>
