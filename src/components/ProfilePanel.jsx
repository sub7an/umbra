  ...
  return (
    <div
      ...
      style={{
        ...
        background: isVisited ? 'rgba(180,77,255,0.1)' : 'rgba(255,255,255,0.03)',
        border: `1px solid ${isVisited ? 'rgba(180,77,255,0.35)' : 'rgba(255,255,255,0.07)'}`,
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        fontFamily: 'JetBrains Mono, monospace', fontSize: 9, fontWeight: 700,
        color: isVisited ? '#b44dff' : 'rgba(255,255,255,0.15)',
        cursor: 'default',
      }}
    >{firstChar}</div>
  )
...
function StatBlock({ label, value, color = '#b44dff' }) {
  return (
    <div style={{
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          color: open ? '#b44dff' : 'rgba(200,230,220,0.55)',
          background: open ? 'rgba(180,77,255,0.07)' : 'rgba(7,4,26,0.72)',
          border: `1px solid ${open ? 'rgba(180,77,255,0.28)' : 'rgba(255,255,255,0.07)'}`,
          borderRadius: 5,
        ...
        <div style={{
          ...
          <div style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
              ...
              <StatBlock label="JOURNEYS" value={`${completedJourneys}/5`} color="#b44dff" />
              <StatBlock label="STREAK" value={streak > 0 ? `🔥${streak}` : '—'} color="#f59e0b" />
            </div>

            {/* Journeys */}
            <div>
              <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.14em', color: 'rgba(180,77,255,0.60)', marginBottom: 10 }}>GUIDED JOURNEYS</div>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.14em', color: 'rgba(180,77,255,0.60)' }}>MODULES EXPLORED</div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.14em', color: 'rgba(180,77,255,0.60)' }}>TODAY'S CHALLENGES</div>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, fontWeight: 700, color: challengesDoneToday === 5 ? '#22c55e' : '#b44dff' }}>
              ...
              <div style={{ height: 4, background: 'rgba(255,255,255,0.06)', borderRadius: 2, marginTop: 8, overflow: 'hidden' }}>
                <div style={{
                  ...
                  background: challengesDoneToday === 5 ? '#22c55e' : '#b44dff',
          ...
          {/* Footer */}
          <div style={{
            padding: '10px 16px', borderTop: '1px solid rgba(180,77,255,0.07)',
