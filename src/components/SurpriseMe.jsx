  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        background: '#b44dff', boxShadow: '0 0 8px #b44dff',
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          color: spinning ? 'rgba(180,77,255,0.3)' : 'rgba(180,77,255,0.55)',
        ...
        onMouseEnter={e => { if (!spinning) { e.currentTarget.style.color = 'rgba(180,77,255,0.9)'; e.currentTarget.style.borderColor = 'rgba(180,77,255,0.3)' }}}
        onMouseLeave={e => { e.currentTarget.style.color = 'rgba(180,77,255,0.55)'; e.currentTarget.style.borderColor = 'rgba(180,77,255,0.12)' }}
      >
