  ...
  return (
    <section className="relative flex flex-col items-center justify-center w-full min-h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 75% 65% at 50% 42%, transparent 15%, rgba(7,11,13,0.75) 65%, #07041a 90%)',
        }}
      />
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to bottom, transparent, #07041a)' }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-2xl mx-auto">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to right, transparent, rgba(180,77,255,0.45), transparent)',
          }}
        />
