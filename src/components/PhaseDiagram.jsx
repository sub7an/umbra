...
export default function PhaseDiagram() {
  ...
  // ── Collapsed toggle ──────────────────────────────────────────────────────
  const accentColor = cfg ? 'rgba(94,106,210,0.6)' : 'rgba(255,255,255,0.15)'

  return (
    <div style={{ borderTop: '1px solid rgba(94,106,210,0.06)', background: 'rgba(1,6,12,0.97)', flexShrink: 0 }}>
      {/* Toggle bar */}
      <button
