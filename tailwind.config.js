...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-cyan': '0 0 8px 2px rgba(245,158,11,0.35)',
        'glow-cyan-strong': '0 0 16px 4px rgba(245,158,11,0.5)',
        ...
        'panel-inset': 'inset 0 1px 0 rgba(245,158,11,0.08)',
      },
      animation: {
